...
export default function Home() {
  return (
    <div className="space-y-8">
      {/* Section 1: Biểu đồ VNINDEX và Tin tức mới nhất */}
      <section className="py-12 space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="col-span-12 md:col-span-4 bg-card rounded-lg border p-4 shadow-sm">
            <LatestNews />
          </div>
        </div>
      </section>

      {/* Section 2: Mã Chứng Khoán - Giá - Lợi nhuận - Chỉ số Q-index - KLGD - Biểu đồ */}
      ...
      {/* Section 3: Thị trường tiền tệ và Tin tức tiền tệ */}
      <section className="py-6">
      ...
      {/* Section 4: Tài sản - Bất động sản - Cổ phiếu - Trái phiếu - Crypto */}
    </div>
  );
} 